...
public class PinyinUtil {
    ...
    public static String getPinYin(String src) {
        char[] t1 = null;
        t1 = src.toCharArray();
        // org.eispframework.core.util.LogUtil.info(t1.length);
        String[] t2 = new String[t1.length];
        // org.eispframework.core.util.LogUtil.info(t2.length);
        // 设置汉字拼音输出的格式
        ...
        try {
            for (int i = 0; i < t0; i++) {
                // 判断能否为汉字字符
                // org.eispframework.core.util.LogUtil.info(t1[i]);
    ...
    public static void main(String[] args) {
        System.out.println(getNameInitial("宋晓强"));
    }
    ...
    public static String getCnASCII(String cnStr) {
        ...
        for (int i = 0; i < bGBK.length; i++) {
            // org.eispframework.core.util.LogUtil.info(Integer.toHexString(bGBK[i] & 0xff));
            // 将每个字符转换成ASCII码
